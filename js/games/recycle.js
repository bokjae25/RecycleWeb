...
window.RecycleGame = (function () {
  const DIFFS = {
    easy:   { bins: 2, spawnMs: 1900, itemR: 34, maxItems: 3, duration: 45 },
    normal: { bins: 3, spawnMs: 1500, itemR: 28, maxItems: 4, duration: 40 },
    hard:   { bins: 4, spawnMs: 1150, itemR: 24, maxItems: 5, duration: 38 },
  };
  const CATEGORIES = [
